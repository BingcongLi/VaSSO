...
def main(args):
    ...
    # build solver
    optimizer, base_optimizer = build_optimizer(args, model=model_without_ddp, model_adv=model_adv)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        logger.log(
            msg.format(epoch=epoch, **train_stats, **val_stats, max_acc=max_acc, epoch_time=time.time() - start_epoch))
